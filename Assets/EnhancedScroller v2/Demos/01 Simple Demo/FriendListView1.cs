...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    /// </summary>
    public class FriendListView1: MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        ...
        /// </summary>
        public FriendItem3 cellViewPrefab;
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            FriendItem3 cellView = scroller.GetCellView(cellViewPrefab) as FriendItem3;
