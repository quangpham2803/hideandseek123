...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    /// </summary>
    public class RequestListView: MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        /// Internal representation of our data. Note that the scroller will never see
        /// this, so it separates the data from the layout using MVC principles.
        /// </summary>
        public SmallList<string> _data;
        ...
        /// </summary>
        public RequestFriendItem cellViewPrefab;
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            RequestFriendItem cellView = scroller.GetCellView(cellViewPrefab) as RequestFriendItem;

            // in this example, we just pass the data to our cell's view which will update its UI
            cellView.GetPlayerProfile(_data[dataIndex]);
