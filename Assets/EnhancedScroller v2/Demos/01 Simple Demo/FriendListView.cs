...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    /// </summary>
    public class FriendListView: MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        ...
        /// </summary>
        public FriendItem2 cellViewPrefab;
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            FriendItem2 cellView = scroller.GetCellView(cellViewPrefab) as FriendItem2;
